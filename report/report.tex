...
First of all we have replied the same experiment of \cite{sparnet} (with \textit{egornn} in place of the Action Recognition Block). The results are shown in \reff{ms_table}.
