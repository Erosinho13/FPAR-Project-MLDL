...
This was about the precision. To address the problem of forcing the network to include motion clues, we avoided using optical flow for this purpose following the work of \cite{flowcit1}.
