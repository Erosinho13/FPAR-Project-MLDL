...
class AttentionModelMSBig(nn.Module):
    def __init__(self, num_classes = 61, mem_size = 512, dim_block=28):
        super(AttentionModelMSBig, self).__init__()
        ...
        self.msBlock = msblock(dim_block, reg=False)
...
def attention_model_ms_bigger(**kwargs):
    return AttentionModelMSBig(**kwargs)